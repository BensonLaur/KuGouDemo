...
playModeWidget::playModeWidget(QWidget*p)
    :baseWidget(p)
    ,m_btnOrder(":/image/bottomwidget/btn_listcircle (1).png",":/image/bottomwidget/btn_listcircle (2).png","列表循环",this)
    ,m_btnRandom(":/image/bottomwidget/btn_listrandom (1).png",":/image/bottomwidget/btn_listrandom (2).png","随机播放",this)
    ,m_btnOneCircle(":/image/bottomwidget/btn_listscircle_single (1).png",":/image/bottomwidget/btn_listscircle_single (2).png","单曲循环",this)
{
...
///////////////
/// \brief AddLoveListTips::AddLoveListTips
/// \param p
///
AddLoveListTips::AddLoveListTips(QWidget *p)
    :baseWidget(p)
    ,m_closebtn(this)
    ,m_tipslab(this)
{
